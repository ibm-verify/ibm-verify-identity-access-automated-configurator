...
The mapping rule files can be downloaded from the [federation demo](https://www.github.com/ibm-verify/ibm-verify-identity-access-automated-configurator/blob/stable/examples/federation_demo/mapping_rules.zip)
